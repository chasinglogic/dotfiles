...
(defun find-mu4e-load-path ()
  (let ((possible-paths (list "/usr/local/share/emacs/site-lisp/mu4e"
                              "/usr/share/emacs/site-lisp/mu4e")))
    (car
     (remove nil
             (mapc 'file-exists-p possible-paths)))))
...
(setq-default user-full-name "Mathew Robinson"
              ...
              mu4e-load-path (find-mu4e-load-path))
